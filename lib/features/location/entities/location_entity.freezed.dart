    ...
    return _then(_value.copyWith(
      ...
      locationReviews: null == locationReviews
          ...
          : locationReviews // ignore: cast_nullable_to_non_nullable
              as String,
      locationRate: null == locationRate
          ? _value.locationRate
          : locationRate // ignore: cast_nullable_to_non_nullable
              as double,
      personWhoAddedLocation: null == personWhoAddedLocation
          ...
          : personWhoAddedLocation // ignore: cast_nullable_to_non_nullable
              as String,
      dateTimeWhenLocationAdded: null == dateTimeWhenLocationAdded
      ...
      locationImages: null == locationImages
          ...
          : locationImages // ignore: cast_nullable_to_non_nullable
              as List<String>,
      additionalServicesChips: null == additionalServicesChips
          ? _value.additionalServicesChips
          : additionalServicesChips // ignore: cast_nullable_to_non_nullable
              as List<String>,
      locationCoverPhoto: null == locationCoverPhoto
    ...
    return _then(_$_LocationEntity(
      ...
      locationImages: null == locationImages
          ...
          : locationImages // ignore: cast_nullable_to_non_nullable
              as List<String>,
      additionalServicesChips: null == additionalServicesChips
          ? _value._additionalServicesChips
          : additionalServicesChips // ignore: cast_nullable_to_non_nullable
              as List<String>,
      locationCoverPhoto: null == locationCoverPhoto
          ? _value.locationCoverPhoto
...
class _$_LocationEntity implements _LocationEntity {
  ...
  List<String> get locationMenuImages {
    if (_locationMenuImages is EqualUnmodifiableListView)
      return _locationMenuImages;
  ...
  final List<String> _additionalServicesChips;
  @override
  List<String> get additionalServicesChips {
    if (_additionalServicesChips is EqualUnmodifiableListView)
      return _additionalServicesChips;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_additionalServicesChips);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.locationRate, locationRate) ||
